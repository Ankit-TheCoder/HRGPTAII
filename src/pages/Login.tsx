        ...
        >
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center">
              <input type="checkbox" className="form-checkbox h-4 w-4 text-primary rounded border-gray-300 dark:border-gray-600" />
              <span className="ml-2">Remember me</span>
            </label>
            <Link to="/forgot-password" className="link text-primary hover:text-primary-dark transition-colors">
              Forgot password?
            </Link>
          </div>
